                ...
                >
                  <div className="relative">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center px-8 py-3.5 bg-primary-500 text-white font-bold rounded-full hover:bg-primary-600 hover:shadow-lg hover:shadow-primary-500/30 transition-all duration-300 hover:scale-105 shadow-md"
                    >
                      Book a Call
                    </a>
                  </div>
