...
export default function FinancialAnalysis({ results, currency }: FinancialAnalysisProps) {
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div className="px-8 py-6 text-white" style={{ background: 'linear-gradient(135deg, #1F2937 0%, #374151 100%)' }}>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-3xl font-bold">Financial Analysis</h2>
          </div>
          <p className="text-gray-300">
            Revenue opportunities and financial impact assessment
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-green-200">
                ...
                <p className="text-4xl font-bold text-green-600 mb-1">
                  {formatCurrency(financialAnalysis.opportunityAnalysis.totalMonthlyOpportunity, currency)}
                </p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-green-200">
                ...
                <p className="text-4xl font-bold text-green-600 mb-1">
                  {formatCurrency(financialAnalysis.opportunityAnalysis.totalAnnualOpportunity, currency)}
                </p>
                <p className="text-sm text-gray-500">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-blue-200">
                ...
                <p className="text-4xl font-bold text-blue-600 mb-1">
                  {formatCurrency(financialAnalysis.opportunityAnalysis.totalThreeYearValue, currency)}
                </p>
                <p className="text-sm text-gray-500">
                  Cumulative impact
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
              ...
              <p className="text-3xl font-bold text-blue-900">
                {formatCurrency(financialAnalysis.opportunityAnalysis.requiredInvestment, currency)}
              </p>
                ...
                <div key={month.month} className="space-y-1">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-gray-600">
                      +{formatCurrency(month.incremental, currency)} ({((month.incremental / month.baseline) * 100).toFixed(0)}%)
                    </span>
                  </div>
                  <div className="relative h-12 bg-gray-100 rounded-lg overflow-hidden">
                    ...
                    >
                      <span className="text-xs font-medium text-blue-800">
                        {formatCurrency(month.baseline, currency)}
                      </span>
                    </div>
                    <div
                    ...
                    >
                      <span className="text-xs font-bold text-white">
                        {formatCurrency(month.optimized, currency)}
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-100 text-sm leading-relaxed">
                ...
                performance. Actual results may exceed projections with proper execution. The {formatCurrency(financialAnalysis.opportunityAnalysis.requiredInvestment, currency)} investment
...
function MetricCard({ label, current, target, format, icon, currency }: MetricCardProps) {
