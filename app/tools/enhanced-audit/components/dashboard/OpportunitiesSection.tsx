...
export default function OpportunitiesSection({ results, currency }: { results: EnhancedAuditResults; currency: string }) {
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-3xl font-bold">Prioritized Opportunities</h2>
      </div>
          ...
          <div key={opp.id} className="border-l-4 border-blue-500 bg-blue-50 p-6 rounded-r-xl">
            <div className="flex items-start justify-between mb-3">
              ...
              <span className="px-3 py-1 bg-green-600 text-white rounded-full text-sm font-bold">
                {formatCurrency(opp.annualRevenue, currency)}/yr
              </span>
            </div>
