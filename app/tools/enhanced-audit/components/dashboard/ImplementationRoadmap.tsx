...
export default function ImplementationRoadmap({ results, currency }: { results: EnhancedAuditResults; currency: string }) {
  return (
          ...
          <div key={phase.phase} className="border-2 border-gray-200 rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <p className="text-2xl font-bold text-green-600">{formatCurrency(phase.expectedRevenue, currency)}</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">Investment Required</p>
                <p className="text-2xl font-bold text-blue-600">{formatCurrency(phase.requiredInvestment, currency)}</p>
              </div>
            </div>
